            ...
            <div className="movie-card">
                ...
                <div className="right">
                    ...
                    <div className="footer">
                        ...
                        <button className={fav?"unfavourite-btn":"favourite-btn"}  onClick={()=> onClickFav(movies)}>
                        ...
                        <button className={isInCart?"unfavourite-btn":"cart-btn"}  onClick={()=>onClickAddtocart(movies)}>
